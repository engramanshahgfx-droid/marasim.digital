        ...
        <main className="mx-auto max-w-lg px-4 pb-16 pt-28">
          ...
          <div className="mb-6 text-center">
            <h1 className="text-2xl font-bold text-gray-900">
              {t('QR Check-In Scanner', 'ماسح رمز QR للتسجيل')}
            </h1>
          ...
          {scanState === 'success' && result && (
            <div className="rounded-2xl border border-green-200 bg-green-50 p-6 text-center shadow-sm">
              ...
              <button onClick={resetScan} className="mt-4 w-full rounded-xl bg-green-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-green-700">
          ...
          {scanState === 'duplicate' && result && (
            <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-center shadow-sm">
              ...
              <button onClick={resetScan} className="mt-4 w-full rounded-xl bg-amber-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-amber-600">
                {t('Scan Next Guest', 'مسح الضيف التالي')}
              </button>
            </div>
          )}
          ...
          {scanState === 'error' && (
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-center shadow-sm">
              ...
              <button onClick={resetScan} className="mt-4 w-full rounded-xl bg-red-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-red-600">
